...
function visFunction1() {
    ...
    document.getElementById("EXAMimg").style.display = "contents";
...
function visFunction3() {
    ...
    document.getElementById("INTimg").style.display = "contents";
    document.getElementById("RESimg").style.display = "none";
...
function visFunction4() {
    ...
    document.getElementById("INTimg").style.display = "none";
    document.getElementById("RESimg").style.display = "contents";
